    ...
    <section className="relative min-h-screen flex items-center justify-center bg-white py-12 mt-[-1.5cm] sm:mt-0">
      <div className="max-w-[1400px] w-full px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          {/* Placeholder for future content - Hidden on mobile, visible on desktop */}
          <div
            className="hidden lg:flex relative z-10 items-center justify-center bg-gradient-to-br from-blue-100 to-slate-200 rounded-lg shadow-lg"
            style={{ height: "720px" }}
          >
            <div className="text-center p-8">
